var fs = require('fs'),
    ...
    overwrite = require('overwrite').default,
	runtime = new overwrite('postman-runtime', {
	    "lib/requester/util.js":function(content){
	        return content.replace("self.ensureHeaderExists(options.headers, 'User-Agent', 'PostmanRuntime/' + version);",'');
        }
    }),
    util = require('../util'),
     ...
     */
    defaultReporters = {
        cli: require('../reporters/cli/index'),
        json: require('../reporters/json/index'),
        html: require('../reporters/html/index'),
        junit: require('../reporters/junit/index'),
